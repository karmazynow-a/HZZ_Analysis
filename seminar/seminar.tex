...
Our analysis:
\begin{equation}
\sigma^{\hzz, \: \mathrm{nom}}=3.62 \: \pm 3.4 \: \mathrm{(stat)} \: \pm 0.98 \: \mathrm{(syst)} \: \pm 0.05 \: \mathrm{(lumi) \: fb}
\end{equation}

ATLAS publication \cite{hzz}:
\begin{equation}
\sigma^{\hzz, \: \mathrm{nom}}=1.14 \: \pm 0.5 \: \mathrm{(stat)} \: \pm 0.25 \: \mathrm{(syst)} \: \mathrm{fb}
\end{equation}
